...
static void mshabal_compress_sse2(mshabal_context *sc, const unsigned char *buf0,
...
void mshabal_sse2(mshabal_context *sc, const void *data0, const void *data1, const void *data2,
    ...
    num = len >> 6;
    if (num != 0) {
        mshabal_compress_sse2(sc, (const unsigned char*)data0, (const unsigned char*)data1,
...
void mshabal_close_sse2(mshabal_context *sc, unsigned ub0, unsigned ub1, unsigned ub2, unsigned ub3,
