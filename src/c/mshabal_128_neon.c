...
static void mshabal_compress_neon(mshabal_context *sc, const unsigned char *buf0,
...
void mshabal_neon(mshabal_context *sc, const void *data0, const void *data1, const void *data2,
   ...
   num = len >> 6;
    if (num != 0) {
        mshabal_compress_neon(sc, (const unsigned char*)data0, (const unsigned char*)data1,
...
void mshabal_close_neon(mshabal_context *sc, unsigned ub0, unsigned ub1, unsigned ub2, unsigned ub3,
...
void mshabal_deadline_fast_neon(mshabal_context_fast *sc, void *message, void *termination, void *dst0,
